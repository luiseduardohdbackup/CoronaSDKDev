return {
	start=function()
		game.states.current = game.stateNames.instructions
		...
		game.board:writeText(2,2,"Instructions",game.board.colors.lightCyan,game.board.colors.black)
	...
	onKeyDown=function(theKey)
		if theKey=="A" then
			game.states.instructions.finish(game.stateNames.mainMenu)
		end
	end,
